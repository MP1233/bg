...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Im /media/ubuntu/OS/braingame/nrml_3d/L4_BP_bAC217_1/mechanisms/Im.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/media/ubuntu/OS/braingame/nrml_3d/L4_BP_bAC217_1/mechanisms/Im.mod";
static const char* nmodl_file_text = 
