...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 ProbAMPANMDA_EMS /media/ubuntu/OS/braingame/nrml_3d/L4_BP_bAC217_1/mechanisms/ProbAMPANMDA_EMS.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/media/ubuntu/OS/braingame/nrml_3d/L4_BP_bAC217_1/mechanisms/ProbAMPANMDA_EMS.mod";
static const char* nmodl_file_text = 
  "\n"
  " \n"
  "\n"
