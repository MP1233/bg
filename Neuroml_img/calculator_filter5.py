...
netParams.connParams['OscMINUS'] = {     'preConds': {'pop': 'Operator_MINUS'},    'postConds': {'pop': 'Operator_MINUS'},    'probability': exc_probability1,    'weight': exc_weight,    'delay': exc_delay1,    'synMech': 'exc'} 
...
simConfig.analysis['plotTraces'] = {'include': [0,55,65,215,225], 'saveFig': True}  # 0 - PLUS, 2 - Comp 1 0, 6 - Comp 2 0, 
